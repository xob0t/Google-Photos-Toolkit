      ...
      <form class="settings-form">
        <details class="settings">
          ...
          <fieldset>
            ...
            <legend>Albums Page Size</legend>
            <div class="input-wrapper">
              <input name="albumsPageSize" value="100" max="100" min="1" type="number" required>
            </div>
...
`);
  ...
  const version = `v${"2.3.2-albums-issue"}`;
  // eslint-disable-next-line no-undef
